...
public class Traversal {
     ...
     * This method builds the tree silently (without extra console output) for use in the traversal method.
    ...
    public static int[] traverse(int[] treeBuilderNumbers, String traversalMethod) {
        ...
        switch (traversalMethod.toLowerCase()) {
            ...
            case "levelorder":
                ...
                break;
            default:
                throw new IllegalArgumentException("Unbekannte Traversierungsart: " + traversalMethod + 
     ...
     */
    private static void levelOrderTraversal(AVLNode levelOrderRoot, List<Integer> levelOrderResultList) {

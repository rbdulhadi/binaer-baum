...
public class AVLTree {
    ...
    private boolean insertHelper(AVLNode currentNode, int insertValue) {
        if (insertValue == currentNode.value) {
            System.out.println("Einfügen: " + insertValue + " - Zahl bereits vorhanden, wird übersprungen");
            return false;
        }
    ...
    private AVLNode balanceNode(AVLNode unbalancedNode) {
        ...
        // Print AVL check
        System.out.println("AVL-Prüfung für Knoten " + unbalancedNode.value + ": Balance-Faktor = " + balanceFactor);
    ...
    private void printTreeRecursive(AVLNode printNode, String prefix, boolean isLast) {
        ...
        System.out.println(printNode.value + " (Höhe: " + printNode.height + ", Balance: " + printNode.getBalanceFactor() + ")");
    ...
    /**
     * Tree visualization in the format specified in requirements.
     * Example output:
     *     8
     *    / \
     *   4   9
